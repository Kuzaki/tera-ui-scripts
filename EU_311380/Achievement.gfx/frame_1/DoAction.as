...
myListener.OnGame_Achievement_SetGradeInfomation = function(_achievementData)
{
    ...
    var _loc16_ = getPosY(TYPE_ACHIEVEMENT);
    lScroll.pageSize = 0;
    lScroll.scroll = 0;
    var _loc12_ = undefined;
    var _loc8_ = lib.util.ExtString.split(_achievementData,"\n");
    var _loc9_ = _loc8_.length;
    var _loc6_ = container_mc.listContainer;
    var _loc13_ = "achievment_Title";
    var _loc10_ = container_mc.listContainer.attachMovie("AchievTitle",_loc13_,_loc6_.getNextHighestDepth());
    _loc10_._x = 7;
    _loc10_._y = 15;
    var _loc15_ = lib.util.UIString.getUIString("$007031");
    _loc10_.textField.htmlText = _loc15_;
    pageData.push(_idx);
    var _loc3_ = 0;
    while(_loc3_ < _loc9_)
    {
        ...
        var _loc5_ = _loc2_[0];
        var _loc4_ = "achievment_grade_" + _loc5_;
        var _loc1_ = _loc6_.attachMovie("Achievment_grade",_loc4_,_loc6_.getNextHighestDepth());
        ...
        _loc1_.gradeMc1.classMc.gotoAndStop(Number(_loc2_[3]) + 2);
        _loc1_.gradeMc2.achievementMc.gotoAndStop(Number(_loc2_[2]) + 1);
        _loc1_.gradeMc2.classMc.gotoAndStop(Number(_loc2_[3]) + 2);
    ...
    var _loc14_ = _loc1_._y + _loc1_._height - 15;
    ...
    {
        lScroll.setScrollPosition(_loc12_);
    }
};

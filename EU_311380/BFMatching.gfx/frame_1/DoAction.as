...
{
    lib.Debuger.trace("ToGame_BFMatching_DeSelect " + BFid);
    getURL("FSCommand:ToGame_BFMatching_DeSelect",BFid);
}
function ToGame_BFMatching_Select(BFid)
{
    lib.Debuger.trace("ToGame_BFMatching_Select " + BFid);
...
function ToGame_BFMatching_SlayerShop()
{
    fscommand("ToGame_BFMatching_SlayerShop");
}
...
{
    clearBFList();
    var _loc20_ = lib.util.ExtString.split(_listData,"\n");
    var _loc21_ = _loc20_.length;
    ...
    {
        var _loc2_ = lib.util.ExtString.split(_loc20_[_loc3_],"\t");
        var _loc18_ = _loc2_[0];
        var joinState = Number(_loc2_[1]);
        var _loc14_ = _loc2_[2];
        var _loc15_ = _loc2_[3];
        var _loc16_ = _loc2_[4];
        var _loc17_ = _loc2_[5];
        var _loc8_ = _loc2_[6];
        var _loc4_ = _loc2_[7];
        var _loc12_ = _loc2_[8];
        var _loc13_ = _loc2_[9];
        var _loc19_ = _loc2_[11];
        if(joinState == 1 || _loc3_ == 0)
        {
            guideFocusType = _loc19_;
        ...
        var _loc10_ = 0;
        var _loc11_ = 0;
        _loc10_ = Number(_loc2_[10]);
        _loc11_ = Number(_loc2_[13]);
        ...
        lineMc.idx = _loc3_;
        lineMc.id = _loc18_;
        lineMc.levelMc.txt.text = _loc14_;
        lineMc.txt0.setText(_loc15_);
        lineMc.partyMc._x = lineMc.txt0._x + lineMc.txt0.textWidth + 4;
        if(_loc10_ > 0)
        {
            lineMc.partyMc._visible = true;
            lineMc.partyMc.txt.text = _loc10_;
        ...
        lineMc.coolTimeMc.txt1.text = _loc8_;
        lineMc.coolTimeMc.txt1._visible = _loc5_;
        if(_loc5_)
        {
        ...
        else
        {
            ...
            lineMc.coolTimeMc.IconMc._visible = _loc9_;
            if(_loc9_)
            {
        ...
        lineMc.onEnterFrame = function()
        {
            if(this.checkMode != -1)
            {
                ...
                this.txt4.text = lib.util.UIString.getUIString(checkText[0]);
        ...
        lineMc.txt1.setText(_loc16_);
        lib.util.DrawBitmap.draw(lineMc.mapMc,_loc17_);
        if(_loc12_ != -1)
        {
            lineMc.txt22.setText(_loc12_);
        }
        if(_loc13_ != -1)
        {
            lineMc.txt32.setText(_loc13_);
        }
        var _loc7_ = lineMc.txt21.textWidth;
        var _loc6_ = lineMc.txt31.textWidth;
        if(_loc7_ > _loc6_)
        {
        ...
        {
            lineMc.txt22._x = 247 + _loc6_ + 20;
            lineMc.txt32._x = 247 + _loc6_ + 20;
        }
        ...
        lineMc.helpMc.txtHelp.text = lib.util.UIString.getUIString("$002003");
        lineMc.helpMc.helpBtn.id = lineMc.id;
        lineMc.helpMc.helpBtn.onRelease = function()
        {
            ToGame_BFMatching_ShowHelp(this.id);
        };
...
myListener.OnGame_BFMatching_SetPoints = function(victoryPoint, slayerPoint)
{
    ...
    container_mc.shopUI.slayerPoint.htmlText = slayerPoint;
};
...
container_mc.shopUI.txtShop2.htmlText = lib.util.UIString.getUIString("$279302");
...
var slayerBtn = new lib.util.TxtBtn(container_mc.shopUI.slayerBtn,container_mc.shopUI.btn_txt12);
slayerBtn.setTextColor(16773561,16777215,16773561,10268600);
...
slayerBtn.setTextColor(lib.info.TextColor.BTN_UINIQUE_NORMAL,lib.info.TextColor.BTN_UINIQUE_OVER,lib.info.TextColor.BTN_UINIQUE_PRESS,lib.info.TextColor.BTN_UINIQUE_DISABLE);
...
slayerBtn.setRelease(ToGame_BFMatching_SlayerShop);

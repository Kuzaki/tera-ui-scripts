...
function isChanged(fd, code)
{
    ...
    var _loc2_ = _loc5_.split("_");
    var _loc3_ = _loc2_[1];
    var _loc6_ = _loc2_[2];
    var _loc4_ = fd._name != "key0_txt"?1:0;
    var _loc1_ = keyMaps[_loc3_][_loc6_][_loc4_];
    lib.Debuger.trace("saveKey  :  " + _loc1_);
    lib.Debuger.trace("code  :  " + code);
    return _loc1_ != code;
}
...
var skilPosSelectO = {};
container_mc.contents_mc.radiobtn2.addListener(skilPosSelectO);
container_mc.contents_mc.radiobtn3.addListener(skilPosSelectO);

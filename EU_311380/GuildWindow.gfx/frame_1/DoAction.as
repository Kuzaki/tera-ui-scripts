...
function setWarList(warInfo)
{
    ...
    var _loc26_ = warInfo[2];
    var _loc27_ = warInfo[3];
    var _loc10_ = warInfo[4];
    var _loc25_ = warInfo[5];
    var _loc17_ = warInfo[6];
    var _loc5_ = warInfo[7];
    var _loc22_ = warInfo[8];
    var _loc9_ = warInfo[9];
    var _loc19_ = warInfo[10];
    var _loc20_ = warInfo[11];
    var _loc15_ = warInfo[12];
    var _loc24_ = Boolean(Number(warInfo[13]));
    var _loc12_ = Boolean(Number(warInfo[14]));
    var _loc21_ = _loc3_ + 1;
    _loc1_.gotoAndStop(_loc21_);
    _loc1_.myNameTF.setText(_loc26_);
    lib.util.DrawBitmap.draw(_loc1_.myImg,_loc27_,50,50);
    _loc1_.myCoinMc.tf.text = _loc10_;
    var _loc8_ = _loc1_.myCoinMc.tf.textWidth;
    var _loc13_ = _loc8_ + 28;
    _loc1_.myCoinMc.tf._width = _loc8_ + 5;
    _loc1_.myCoinMc.mc._x = _loc8_ + 1;
    _loc1_.myCoinMc._x = 137 - _loc13_ / 2;
    lib.manager.ToolTip.add(_loc1_.myCoinMc,_loc25_,1);
    _loc1_.myKillTF.htmlText = _loc17_ + "<font size=\'20\' face=\'$NormalFont\'>" + KILL + "</font>";
    _loc1_.myCoinMc._visible = Number(_loc10_) != 0;
    _loc1_.targetNameTF.setText(_loc5_);
    lib.util.DrawBitmap.draw(_loc1_.targetImg,_loc22_,50,50);
    _loc1_.targetCoinMc.tf.text = _loc9_;
    var _loc7_ = _loc1_.targetCoinMc.tf.textWidth;
    var _loc18_ = _loc7_ + 28;
    _loc1_.targetCoinMc._x = 720 - _loc18_ / 2;
    _loc1_.targetCoinMc.tf._width = _loc7_ + 5;
    _loc1_.targetCoinMc.mc._x = _loc7_ + 1;
    lib.manager.ToolTip.add(_loc1_.targetCoinMc,_loc19_,1);
    _loc1_.targetKillTF.htmlText = _loc20_ + "<font size=\'20\' face=\'$NormalFont\' >" + KILL + "</font>";
    _loc1_.targetCoinMc._visible = Number(_loc9_) != 0;
    var _loc14_ = guildWarListTitleTextColor[_loc3_];
    _loc1_.titleTF.textColor = _loc14_;
    var _loc4_ = "";
    switch(_loc3_)
    {
        case 0:
    ...
    var _loc23_ = GUILD_WAR_TYPE_DECLARED != _loc3_?_loc1_.withdrawBtn:_loc1_.counterBtn;
    var _loc11_ = GUILD_WAR_TYPE_DECLARED != _loc3_?null:_loc1_.surrenderBtn;
    _loc23_.setDisabled(_loc24_);
    if(GUILD_WAR_TYPE_DECLARED == _loc3_)
    {
        var _loc16_ = !_loc12_?surrenderTooltipNormalState:surrenderTooltipDisableState;
        _loc11_.setDisabled(_loc12_);
        lib.manager.ToolTip.add(_loc11_,_loc16_,1);
    }
    _loc1_.idx = _loc6_;
}
...
{
    var _loc9_ = container_mc.listMc;
    var _loc12_ = 0;
    listClear(_loc9_,listLen);
    listLen = 0;
    var _loc11_ = lib.util.ExtString.split(dataList,"\n");
    var _loc8_ = _loc11_.shift();
    if(_loc8_ != undefined && _loc8_ != "")
    {
        _loc9_.defaultStr._visible = false;
    }
    else
    {
        _loc9_.defaultStr._visible = true;
    }
    while(_loc8_ != undefined)
    {
        var _loc2_ = lib.util.ExtString.split(_loc8_,"\t");
        if(_loc2_ != undefined)
        {
            var lineMc = _loc9_.boxMc.attachMovie("line1","line" + listLen,_loc9_.boxMc.getNextHighestDepth());
            var _loc7_ = Number(_loc2_[12]);
            lineMc.block_mc._visible = _loc7_;
            if(_loc7_)
            {
            ...
            var _loc10_ = 2 != lineMc.online?_loc2_[2]:_loc2_[13];
            lineMc.txt_4.setText(_loc10_);
        ...
        _loc8_ = _loc11_.shift();
    }
    _loc9_.scrollbar.pageSize = _loc9_.boxMc._height;
    _loc9_.scrollbar.scroll = 0;
};

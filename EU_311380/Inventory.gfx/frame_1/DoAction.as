...
function drawBg()
{
    var _loc20_ = 0;
    var _loc10_ = 0;
    var _loc14_ = BODYBGHEIGHT * slotLineCount;
    lib.display.DrawBitmapData.draw(container_mc,bgTopBm,_loc20_,_loc10_,0,0,BGWIDTH,TOPBGHEIGHT,1);
    var _loc9_ = 0;
    while(_loc9_ < slotLineCount)
    {
        var _loc12_ = _loc10_ + TOPBGHEIGHT + BODYBGHEIGHT * _loc9_;
        lib.display.DrawBitmapData.draw(container_mc,bgBodyBm,_loc20_,_loc12_,0,0,BGWIDTH,BODYBGHEIGHT,1,1,true);
        _loc9_ = _loc9_ + 1;
    }
    if(slotLineCount < LARGESIZELINE)
    {
        lib.display.DrawBitmapData.draw(container_mc,bgBodyLockBm,_loc20_,_loc10_ + TOPBGHEIGHT + _loc14_,0,0,BGWIDTH,BODYBGHEIGHT,1);
        _loc14_ = _loc14_ + BODYBGHEIGHT;
    }
    var _loc11_ = null;
    if(bVisibleEnchantBtn)
    {
        ...
        if(_loc15_ == undefined)
        {
            ...
            {
                ToGame_InventoryWindow_ClickExtBtn(2);
            };
        ...
        _loc15_._y = _loc10_ + TOPBGHEIGHT + _loc14_ + 20;
        enchantBtnIcon._x = _loc15_._x + extBtnWidth / 2 - enchantBtnIcon._width / 2;
        enchantBtnIcon._y = _loc15_._y + 2;
        _loc11_ = _loc15_;
        var _loc26_ = lib.util.UIString.getUIString("$051012");
        lib.manager.ToolTip.add(_loc15_,_loc26_,1);
    }
    if(bVisibleEnchantShiftBtn)
    {
        ...
        if(_loc18_ == undefined)
        {
            ...
            {
                ToGame_InventoryWindow_ClickExtBtn(4);
            };
        ...
        _loc18_._x = _loc11_ == null?SLOTSTARTX:_loc11_._x + extBtnWidth;
        _loc18_._y = _loc10_ + TOPBGHEIGHT + _loc14_ + 20;
        enchantShiftBtnIcon._x = _loc18_._x + extBtnWidth / 2 - enchantShiftBtnIcon._width / 2;
        enchantShiftBtnIcon._y = _loc18_._y + 2;
        _loc11_ = _loc18_;
        _loc26_ = lib.util.UIString.getUIString("$051015");
        lib.manager.ToolTip.add(_loc18_,_loc26_,1);
    }
    if(bVisibleExtractBtn)
    {
        var _loc19_ = container_mc.extractBtn;
        var extractBtnIcon = container_mc.extractBtnIcon;
        if(_loc19_ == undefined)
        {
            _loc19_ = container_mc.attachMovie("extBtnArea","extractBtn",container_mc.getNextHighestDepth());
            ...
            {
                ToGame_InventoryWindow_ClickExtBtn(0);
            };
        ...
        _loc19_._x = _loc11_ == null?SLOTSTARTX:_loc11_._x + extBtnWidth;
        _loc19_._y = _loc10_ + TOPBGHEIGHT + _loc14_ + 20;
        extractBtnIcon._x = _loc19_._x + extBtnWidth / 2 - extractBtnIcon._width / 2;
        extractBtnIcon._y = _loc19_._y + 2;
        _loc11_ = _loc19_;
        var _loc27_ = lib.util.UIString.getUIString("$051010");
        lib.manager.ToolTip.add(_loc19_,_loc27_,1);
    }
    if(bVisibleResetOptionBtn)
    {
        var _loc13_ = container_mc.resetBtn;
        var resetBtnIcon = container_mc.resetBtnIcon;
        if(_loc13_ == undefined)
        {
            _loc13_ = container_mc.attachMovie("extBtnArea","resetBtn",container_mc.getNextHighestDepth());
            _loc13_._width = extBtnWidth;
            ...
            {
                ToGame_InventoryWindow_ClickExtBtn(3);
            };
            _loc13_.onRollOver = function()
            {
                resetBtnIcon.gotoAndStop(2);
            };
            _loc13_.onRollOut = _loc13_.onReleaseOutside = function()
            {
                resetBtnIcon.gotoAndStop(1);
            };
        }
        _loc13_.txt.text = "reset";
        _loc13_._x = _loc11_ == null?SLOTSTARTX:_loc11_._x + extBtnWidth;
        _loc13_._y = _loc10_ + TOPBGHEIGHT + _loc14_ + 20;
        resetBtnIcon._x = _loc13_._x + extBtnWidth / 2 - resetBtnIcon._width / 2;
        resetBtnIcon._y = _loc13_._y + 2;
        _loc11_ = _loc13_;
        var _loc24_ = lib.util.UIString.getUIString("$051013");
        lib.manager.ToolTip.add(_loc13_,_loc24_,1);
    }
    if(bVisibleCrystalBtn)
    {
        ...
        if(_loc16_ == undefined)
        {
            ...
            {
                ToGame_InventoryWindow_ClickExtBtn(1);
            };
        ...
        _loc16_._x = _loc11_ == null?SLOTSTARTX:_loc11_._x + extBtnWidth;
        _loc16_._y = _loc10_ + TOPBGHEIGHT + _loc14_ + 20;
        crystalBtnIcon._x = _loc16_._x + extBtnWidth / 2 - crystalBtnIcon._width / 2;
        crystalBtnIcon._y = _loc16_._y + 2;
        var _loc25_ = lib.util.UIString.getUIString("$051011");
        lib.manager.ToolTip.add(_loc16_,_loc25_,1);
        _loc11_ = _loc16_;
    }
    ...
    var _loc17_ = _loc11_ == null?_loc10_ + TOPBGHEIGHT + _loc14_ + 31:_loc10_ + TOPBGHEIGHT + _loc14_ + 63;
    container_mc.countTxt._y = _loc11_ == null?_loc17_ - 29:_loc10_ + TOPBGHEIGHT + _loc14_ + 2;
    ...
    var _loc23_ = bgBottomBm_0_1;
    var _loc21_ = BOTTOMBGHEIGHT_0_1;
    if(tcatVisible || cMoneyVisible)
    {
        _loc23_ = _loc11_ == null?bgBottomBm_0_2:bgBottomBm_1_2;
        _loc21_ = _loc11_ == null?BOTTOMBGHEIGHT_0_2:BOTTOMBGHEIGHT_1_2;
        lib.display.DrawBitmapData.draw(container_mc,_loc23_,_loc20_,_loc10_ + TOPBGHEIGHT + _loc14_,0,0,BGWIDTH,_loc21_,1);
    ...
    {
        _loc23_ = _loc11_ == null?bgBottomBm_0_1:bgBottomBm_1_1;
        _loc21_ = _loc11_ == null?BOTTOMBGHEIGHT_0_1:BOTTOMBGHEIGHT_1_1;
        lib.display.DrawBitmapData.draw(container_mc,_loc23_,_loc20_,_loc10_ + TOPBGHEIGHT + _loc14_,0,0,BGWIDTH,_loc21_,1);
        lib.display.DrawBitmapData.draw(container_mc,bgMoneyBm,19,_loc17_ - 1,0,0,285,22,1,1,true);
    }
    hit._height = _loc10_ + TOPBGHEIGHT + _loc14_ + _loc21_;
    container_mc.hit._height = _loc10_ + TOPBGHEIGHT + _loc14_ + _loc21_;
    var _loc22_ = SLOTCOLUM * slotLineCount;
    var _loc6_ = 0;
...
var extBtnWidth = 0;
myListener.OnGame_InventoryWindow_ShowExtBtn = function(bExtractBtn, bCrystalBtn, bEnchantBtn, bResetOptionBtn, bEnchantShiftBtn)
{
    ...
    var _loc1_ = Number(bExtractBtn) + Number(bCrystalBtn) + Number(bEnchantBtn) + Number(bResetOptionBtn) + Number(bEnchantShiftBtn);
    extBtnWidth = 340 / _loc1_;
};

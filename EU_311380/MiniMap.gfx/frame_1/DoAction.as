...
function optionLoad()
{
    ...
    optionLoded = true;
    var _loc5_ = 0;
    while(_loc5_ < optinList.length)
    {
        var _loc7_ = optinList[_loc5_];
        ...
        _loc2_.checkMc.onChanged = function()
        {
            ...
            while(_loc1_ < optinList.length)
            {
                ...
                _loc4_ = _loc4_ + (_loc2_ + "\b" + Number(_loc3_.checked) + "\t");
                _loc1_ = _loc1_ + 1;
            }
...
{
    allSymbol_array = [container_mc.enablePk_mc,container_mc.canUseHomun_mc,container_mc.multyIcon_mc,container_mc.guildWarIcon_mc,container_mc.BFIcon_mc,container_mc.dungenPartyIcon_mc,container_mc.eventIcon_mc];
...
{
    allSymbol_array = [container_mc.enablePk_mc,container_mc.multyIcon_mc,container_mc.guildWarIcon_mc,container_mc.BFIcon_mc,container_mc.dungenPartyIcon_mc,container_mc.eventIcon_mc];
...
container_mc.optionOpen_mc.onReleaseOutside = _loc0_ = function()
{
    if(!opened)
    {
        this.gotoAndStop(1);
...
container_mc.optionOpen_mc.onRollOut = _loc0_;
...
container_mc.channel_mc.hit.onReleaseOutside = _loc0_ = function()
{
    container_mc.channel_mc.over._visible = false;
};
container_mc.channel_mc.hit.onRollOut = _loc0_;
container_mc.channel_mc.over._visible = false;
...
myListener.OnGame_Message_Add = function(type, id)
{
    if(type == 16)
    {
        _scope.Help_Icon_Add(id);
    }
};
myListener.OnGame_Message_Remove = function(id)
{
    _scope.Help_Icon_Remove(id);
};

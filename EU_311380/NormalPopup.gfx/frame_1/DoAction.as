    ...
    if(type >= 2)
    {
        ...
        else
        {
            ...
            else if(type == 5)
            {
                ...
                {
                    type51_textField.__set__min(Number(argu9));
                }
                if(argu10 != undefined && argu10 != null)
                {
                    type51_textField.__set__max(Number(argu10));
                }
                ...
                popupType5.GoldCurrencyInput.min = argu9;
                popupType5.GoldCurrencyInput.max = argu10;

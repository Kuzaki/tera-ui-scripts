...
{
    var _loc8_ = curScaleStep / oneStep;
    container_mc.scaleBtn._y = 501 - scaleBarH / maxStep * _loc8_;
    ...
    var _loc5_ = 1 + curScaleStep / 10;
    container_mc.mapContainer_mc.bgImg_mc._xscale = container_mc.mapContainer_mc.bgImg_mc._yscale = _loc5_ * 100;
    container_mc.mapContainer_mc.hit._xscale = container_mc.mapContainer_mc.hit._yscale = _loc5_ * 100;
    var _loc4_ = 0;
    while(_loc4_ < marker_array.length)
    {
        var _loc2_ = marker_array[_loc4_];
        var _loc7_ = _loc2_.posX;
        var _loc6_ = _loc2_.posY;
        _loc2_._x = _loc7_ * _loc5_;
        _loc2_._y = _loc6_ * _loc5_;
        _loc4_ = _loc4_ + 1;
    }
    _loc4_ = 0;
...
function setMouseDown()
{
    myListener.OnGame_MouseDown = function(button, targetMc, target)
    {
        ...
        if(_global.control)
        {
            var _loc5_ = Mouse.getTopMostEntity()._target.split("/");
            if(target == undefined || target == "" || _loc5_[1] == "container_overlayMap_mc")
            {
                if(container_mc._visible && container_mc._xmouse >= 0 && container_mc._xmouse < 768 && container_mc._ymouse >= 0 && container_mc._ymouse < 768)
                {
                    var _loc4_ = "";
                    _loc4_ = _loc4_ + (container_mc.mapContainer_mc._xmouse + "@" + container_mc.mapContainer_mc._ymouse);
                    var _loc7_ = container_mc.mapContainer_mc._x;
                    var _loc6_ = container_mc.mapContainer_mc._y;
                    _root.ToGame_CTRLMouseDown("OverlayMap2",_loc4_);
                }
            }
        }
    };
...
{
    var _loc6_ = container_mc.mapContainer_mc.marker_mc.num;
    var _loc2_ = _loc6_.createEmptyMovieClip(id,_loc6_.getNextHighestDepth());
    var _loc3_ = _loc2_.attachMovie("number","number",_loc2_.getNextHighestDepth());
    _loc3_._x = _loc3_._x + leftMargin;
    _loc3_._y = _loc3_._y + topMargin;
    if(questId != undefined && questId != "" && questId != null && questId != "undefined" && questId != "0" && questId != "-1")
    {
        _loc3_.textFd.textColor = "0xFFFFFF";
    }
    _loc3_.textFd.text = number;
    _loc3_.textFd._x = -1 * leftMargin - 16;
    _loc3_.textFd._y = -1 * topMargin - 11;
    _loc3_.textFd.textAutoSize = "shrink";
    lib.util.DrawBitmap.draw(_loc3_.bg,res);
    var _loc5_ = 1 + curScaleStep / 10;
    _loc2_._x = posX * _loc5_;
    _loc2_._y = posY * _loc5_;
    _loc2_.posX = posX;
    _loc2_.posY = posY;
    _loc2_.id = id;
...
{
    var _loc32_ = dataList.split("\n");
    var _loc33_ = _loc32_.length;
    if(_loc32_[_loc33_ - 1] == "0" || _loc32_[_loc33_ - 1] == "undefined" || _loc32_[_loc33_ - 1] == "")
    {
        _loc32_.pop();
    }
    _loc33_ = _loc32_.length;
    var _loc31_ = 0;
    var _loc18_ = 0;
    while(_loc18_ < _loc33_)
    {
        var _loc4_ = _loc32_[_loc18_].split("\t");
        if(_loc4_.length != 1)
        {
            var _loc5_ = _loc4_[0];
            var _loc20_ = Number(_loc4_[1]);
            var _loc19_ = Number(_loc4_[2]);
            var _loc27_ = Number(_loc4_[3]);
            var _loc8_ = Number(_loc4_[4]);
            var _loc7_ = Number(_loc4_[5]);
            var _loc3_ = _loc4_[6];
            var _loc15_ = _loc4_[7];
            var _loc6_ = Number(_loc4_[8]);
            var _loc25_ = _loc4_[9];
            var _loc17_ = Number(_loc4_[11]);
            var _loc12_ = Number(_loc4_[12]);
            var _loc9_ = Number(_loc4_[13]);
            var _loc10_ = Number(_loc4_[14]);
            if(isNaN(_loc17_) == false && _loc17_ != -1)
            {
                var _loc30_ = _loc4_[10];
                addNumber(_loc30_,_loc5_,_loc8_,_loc7_,_loc3_,_loc20_,_loc19_,_loc17_,_loc15_);
            }
            else
            {
                _loc12_ = !(isNaN(_loc12_) || -1 == _loc12_ || 0 == _loc12_)?_loc12_ * 100:100;
                ...
                if(_loc6_ == 0)
                {
                    lib.util.DrawBitmap.draw(container_mc.mapContainer_mc.bgImg_mc,_loc3_);
                }
                else if(_loc6_ == 5)
                {
                ...
                {
                    if(CITYWAR_MONSTER == _loc3_ || 1 == _loc9_)
                    {
                ...
                else if(_loc6_ == 13)
                {
                    ...
                    {
                        EffectAnimation(_loc31_,_loc3_,_loc2_);
                        _loc31_ = _loc31_ + 1;
                    }
                }
                else if(_loc6_ == 14)
                ...
                {
                    var _loc26_ = out.attachMovie("pingHit","pingHit",out.getNextHighestDepth());
                    _loc26_._alpha = 0;
                }
                else
                {
                ...
                if(_loc3_ == "img://__WMap_Marker.MARKER_BLACKHOLE_BG")
                {
                    _loc13_ = 70;
                }
                lib.util.DrawBitmap.draw(out,_loc3_,_loc13_,_loc13_);
                if(undefined != _loc13_ && _loc8_ == 0 && _loc7_ == 0)
                {
                    out._x = out._x - _loc13_ / 2;
                    out._y = out._y - _loc13_ / 2;
                }
                else
                {
                ...
                out._xscale = out._yscale = _loc12_;
                if(0 < _loc10_)
                {
                    var _loc14_ = _loc2_.attachMovie("markerBg","markerBg",_loc2_.getNextHighestDepth());
                    if(1 == _loc10_ || 2 == _loc10_)
                    {
                        var _loc28_ = _loc14_["gauge_" + _loc10_];
                        _loc14_.gauge_1._visible = 1 == _loc10_;
                        _loc14_.gauge_2._visible = 2 == _loc10_;
                        ...
                        out._x = _loc23_ + 7;
                        out._y = _loc22_ + 19.5;
                        var _loc29_ = getCityWarTowerHP(_loc15_);
                        _loc28_._width = CITYWAR_TOWER_GAUGE_WIDTH * (_loc29_ / 100);
                    }
                }
                if(_loc3_ == "img://__WMap_Marker.MARKER_PC_CAMERA")
                {
                ...
                {
                    var _loc16_ = _loc2_.attachMovie("Warning","Warning",_loc2_.getNextHighestDepth());
                    _loc16_.hitTestDisable = true;
                    _loc16_.blendMode = "add";
                }
                else if(_loc3_ == "img://__WMap_Marker.MARKER_BF_METRO_SKILL")
                {
                    _loc16_ = _loc2_.attachMovie("Warning2","Warning2",-100);
                    _loc16_._x = _loc8_ + 16;
                    _loc16_._y = _loc7_ + 16;
                    _loc16_.hitTestDisable = true;
                    _loc16_.blendMode = "add";
                }
                var _loc24_ = 1 + curScaleStep / 10;
                var _loc21_ = _loc2_;
                if(CITYWAR_MONSTER == _loc3_ || 1 == _loc9_ || _loc3_.substr(0,CITYWAR_COMMAND.length) == CITYWAR_COMMAND)
                {
                    if(1 != _loc9_)
                    {
                        var _loc11_ = _loc2_.attachMovie("citywar_marker_hit","hit",_loc2_.getNextHighestDepth());
                        _loc11_._x = -24;
                        _loc11_._y = -24;
                        _loc11_._alpha = 0;
                    }
                    _loc11_ = 1 != _loc9_?_loc11_:_loc2_.markerBg.hit;
                    _loc21_ = _loc11_;
                    _loc2_.markerHit = _loc11_;
                }
                if("" != _loc15_)
                {
                    _loc9_ = _loc9_ != 1?1:99;
                    lib.manager.ToolTip.add(_loc21_,_loc15_,_loc9_);
                }
                _loc2_._x = _loc20_ * _loc24_;
                _loc2_._y = _loc19_ * _loc24_;
                _loc2_.leftMargin = _loc8_;
                _loc2_.topMargin = _loc7_;
                _loc2_._rotation = _loc27_;
                _loc2_.posX = _loc20_;
                _loc2_.posY = _loc19_;
                if(_loc2_ != null)
                {

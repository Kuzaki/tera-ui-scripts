...
var itemStyleToolTipString = [lib.info.ToolTipStr.ITEM_STYLEWEAPONCUSTOM,lib.info.ToolTipStr.ITEM_STYLEBODYCUSTOM,"","",lib.info.ToolTipStr.ITEM_STYLEHAIRCUSTOM,lib.info.ToolTipStr.ITEM_STYLEFACECUSTOM,"$221144","$221145"];
var isTheOther;
var greetingDefault = lib.util.UIString.getUIString("$221033");
var greetMessage = "";
container_mc.setItemMc._visible = false;
var styleLinkStr = lib.util.UIString.getUIString("$221090");
...
container_mc.styleslotbg.linkFd.styleSheet = lnkStyle;
container_mc.styleslotbg.guideFd.htmlText = "<img src=\'icon_notice\' vspace=\'-1\'>" + lib.util.UIString.getUIString("$221083");
...
function initStyleSlotForPCPremium()
{
    ...
    _loc5_.size = 16;
    var _loc4_ = [100,101,104,105,106];
    var _loc2_ = 0;
...
function setStatus(index)
{
    ...
    if(statusDatas[index].length > 0)
    {
        ...
        while(_loc5_ < statusDatas[index].length)
        {
            ...
            if(_loc1_._label != undefined)
            {
                ...
                lib.manager.ToolTip.add(_loc2_.txt0,_loc1_.tip,1);
            }
            _loc5_ = _loc5_ + 1;
        }
    }
    ...
    lib.Debuger.trace("container_mc.statusContainer._height + 10 : " + container_mc.statusContainer._height + 10);
...
function PaperDoll_Visible(bool)
{
    ...
    {
        lib.Debuger.trace("tab2.activedNum : " + tab2.activedNum);
...
scrollBar.scroll = 0;
container_mc.reputation_mc.txt.htmlText = "<img src=\'icon_notice\' vspace=\'-1\'> " + lib.util.UIString.getUIString("$221079");
...
myListener.OnGameEventShowWindow = function(widgetName, bShow)
{
    if(widgetName.toLowerCase() == UIname.toLowerCase() && (isTheOther == undefined || isTheOther == 0))
    {
        ...
        if(bPremiumitem != "0")
        {
            container_mc.styleslotbg.linkFd.htmlText = "<a href=\'asfunction:_parent._parent.goPremium\'><img src=\'rinkarrow0\' vspace=\'-6\'/><font color=\'#80e71c\'><u>" + styleLinkStr + "</u></font></a>";
            container_mc.styleslotbg.linkFd._y = container_mc.styleslotbg.guideFd._y + container_mc.styleslotbg.guideFd.textHeight + 10;
        }
...
myListener.OnGame_PaperDoll_SetEnchantBtn = function(dataList)
{
    ...
    while(_loc4_ < _loc9_)
    {
        ...
        var _loc2_ = UI["enchantBtn" + _loc3_];
        var _loc7_ = container_mc["enchantBtn__" + _loc3_];
        _loc7_.bVisible = _loc5_;
        lib.Debuger.trace("btnIndex : " + _loc3_ + ", bVisible : " + _loc5_ + ", bDisable : " + _loc6_ + ", btn : " + _loc2_);
        if(tab2.activedNum == 0 && (isTheOther == false || isTheOther == undefined))
        {
            _loc2_.setVisible(_loc5_);
        }
        _loc2_.setEnabled(_loc6_);
        _loc4_ = _loc4_ + 1;
    }
};
...
myListener.OnGameEvent_PaperDoll_SetSilhouette = function(sex, race, _theOther)
{
    ...
    if(_theOther)
    {
        _loc4_ = UIname2.toLowerCase();
    }
    var _loc6_ = flash.display.BitmapData.loadBitmap("img://__S1UIRES_Skin.BG_" + _loc4_ + "_" + _loc1_ + _loc3_);
    container_mc.uiBgMc2.attachBitmap(_loc6_,1);
...
myListener.OnGame_PaperDoll_SetStatus = function(statusType, statusValue, statusAdd, _theOther)
{
    ...
    if(statusAdd != undefined && statusAdd != "" && statusAdd != 0 && statusAdd != "0/0")
    {
        ...
        {
            _loc1_ = "<font size=\'17\' color=\'#FF3300\'> " + statusAdd + "</font>";
        }
        ...
        {
            _loc1_ = "<font size=\'17\' color=\'#58c84e\'> +" + statusAdd + "</font>";
        }
    }
    if(statusType == "totalatk")
    {
        var _loc6_ = statusValue.split("/");
        var _loc5_ = statusAdd.split("/");
        if(_loc1_ != "")
        {
            if(_loc5_[0] == _loc5_[1])
            {
                if(Number(_loc5_[0]) < 0)
                {
                    _loc1_ = "<font size=\'17\' color=\'#FF3300\'> " + _loc5_[0] + "</font>";
                }
                else
                {
                    _loc1_ = "<font size=\'17\' color=\'#58c84e\'> +" + _loc5_[0] + "</font>";
                }
            }
            else
            {
                _loc1_ = "<font size=\'17\' color=\'#58c84e\'> +(" + _loc5_[0] + "~" + _loc5_[1] + ")</font>";
                _loc3_ = _loc6_[0] + "" + _loc1_ + " ~ " + _loc6_[1] + "" + _loc1_;
            }
        }
        if(_loc6_[0] == _loc6_[1])
        {
            _loc3_ = _loc6_[0] + "" + _loc1_;
        }
        else
        {
            _loc3_ = _loc6_[0] + " ~ " + _loc6_[1] + "" + _loc1_;
        }
        _loc1_ = "";
    }
    else if(statusType == "powrt")
    {
        _loc3_ = lib.util.UIString.getUIString("$221029","power",_loc3_ + _loc1_);
        _loc1_ = "";
    }
    for(var _loc7_ in statusDatas)
    {
        if(statusDatas[_loc7_][statusType] != undefined)
        {
            statusDatas[_loc7_][statusType].str = _loc3_ + _loc1_;
        }
    }
...
myListener.OnGame_PaperDoll_SetAllStatus = function(_listData, _theOther)
{
    ...
    var _loc10_ = lib.util.ExtString.split(_listData,"\n");
    ...
    {
        var _loc6_ = lib.util.ExtString.split(_loc10_[_loc7_],"\t");
        var _loc2_ = _loc6_[2];
        _loc8_ = _loc6_[0];
        _loc3_ = _loc6_[1];
        _loc1_ = "";
        if(_loc2_ != undefined && _loc2_ != "" && _loc2_ != 0 && _loc2_ != "0/0")
        {
            if(Number(_loc2_) < 0)
            {
                _loc1_ = "<font size=\'17\' color=\'#FF3300\'> " + _loc2_ + "</font>";
            }
            else if(Number(_loc2_) == 0)
            {
                _loc1_ = "";
            }
            else
            {
                _loc1_ = "<font size=\'17\' color=\'#58c84e\'> +" + _loc2_ + "</font>";
            }
        }
        if(_loc8_ == "totalatk")
        {
            ...
            if(_loc1_ != "")
            {
                if(_loc4_[0] == _loc4_[1])
                {
                    ...
                    {
                        _loc1_ = "<font size=\'17\' color=\'#FF3300\'> " + _loc4_[0] + "</font>";
                    }
                    else
                    {
                        _loc1_ = "<font size=\'17\' color=\'#58c84e\'> +" + _loc4_[0] + "</font>";
                    }
                }
                else
                {
                    _loc1_ = "<font size=\'17\' color=\'#58c84e\'> +(" + _loc4_[0] + "~" + _loc4_[1] + ")</font>";
                    _loc3_ = _loc5_[0] + "" + _loc1_ + " ~ " + _loc5_[1] + "" + _loc1_;
                }
            }
            if(_loc5_[0] == _loc5_[1])
            {
                _loc3_ = _loc5_[0] + "" + _loc1_;
            }
            else
            {
                _loc3_ = _loc5_[0] + " ~ " + _loc5_[1] + "" + _loc1_;
            }
            _loc1_ = "";
        }
        ...
        for(var _loc9_ in statusDatas)
        {
            if(statusDatas[_loc9_][_loc6_[0]] != undefined)
            {
                statusDatas[_loc9_][_loc6_[0]].str = _loc3_ + _loc1_;
            }
        }
        _loc7_ = _loc7_ + 1;
    }
...
{
    lib.Debuger.trace("OnGame_PaperDoll_InstanceDungeon");
    if(Number(_theOther) != Number(isTheOther))
    {
        return undefined;
    }
...
myListener.OnGame_PaperDoll_SetDataPVP = function(_Index, _Title, _Setdata, _theOther)
{
    ...
    while(_loc2_ < _loc9_)
    {
        ...
        else
        {
            ...
            var _loc3_ = _loc5_.attachMovie("pvpList","pvpList" + _loc2_,_loc2_);
            _loc3_.txt1.verticalAlign = "center";
            _loc3_.txt0.htmlText = _loc6_[0];
            _loc3_.txt1.htmlText = _loc6_[1];
            _loc3_._y = _loc4_;
            _loc4_ = _loc4_ + 30;
            _loc5_.bg._height = _loc4_;
        }
        _loc2_ = _loc2_ + 1;
    }
    SetPvpPosition();
...
container_mc.pvp_btn.onRelease = function()
{
    ...
    container_mc.notice_mc.txt.htmlText = "";
};

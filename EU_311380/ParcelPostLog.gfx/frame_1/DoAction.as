...
myListener.OnGame_ParcelPostLog_SetData = function(dataList, currentPage, totalPage, totalMessge)
{
    ...
    var _loc9_ = totalMessge < 70?lib.info.TextColor.GENERAL_NORMAL.toString(16):lib.info.TextColor.GENERAL_CRITICAL.toString(16);
    ...
    if(_loc15_[0] != undefined && _loc15_[0] != "")
    {
    ...
    while(_loc8_ < LINELENGTH)
    {
        ...
        if(_loc5_ != undefined)
        {
            ...
            lib.manager.ToolTip.add(_loc2_.iconMc,strObj["messageType" + _loc4_],1);
            if(_loc11_ && !isMode)
            {
            ...
            {
                _loc9_ = lib.info.TextColor.PARCELPOST_STATE_UNPAYMENT.toString(16);
                if(_loc6_ == 1)
                {
                    _loc9_ = lib.info.TextColor.PARCELPOST_STATE_RECEIVED.toString(16);
                }
                else if(_loc6_ == 2)
                {
                    _loc9_ = lib.info.TextColor.PARCELPOST_STATE_SENDBACK.toString(16);
                }
                if(_loc4_ == 3)
                {
                    _loc2_.txt_2.htmlText = "<font color=\'#" + _loc9_ + "\'>" + strObj["recieveStr" + _loc6_] + "</font>";
                }
                else
                {
                    _loc2_.txt_2.htmlText = "<font color=\'#" + _loc9_ + "\'>" + strObj["recieveStr" + _loc6_] + "</font>";
            ...
            _loc2_.checkBox._visible = isMode == 0;
            if(_loc4_ != 0 && !isMode && _loc6_ == 0)
            {
                _loc2_.checkBox.enabled = false;
...
myListener.OnGame_ParcelPostLog_ChangeMode = function(_mode)
{
    ...
    containerMc.checkAll._visible = isMode == 0;

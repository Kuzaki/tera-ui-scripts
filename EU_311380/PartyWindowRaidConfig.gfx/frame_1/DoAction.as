function ToGame_PartyWindowRaidConfig_SetView(num)
{
    getURL("FSCommand:ToGame_PartyWindowRaidConfig_SetView",num);
}
function ToGame_PartyWindowRaidConfig_SetCheck()
{
    var _loc2_ = "";
    var _loc3_ = CHECKLEN - 1;
    var _loc1_ = 0;
    while(_loc1_ < _loc3_)
    {
        _loc2_ = _loc2_ + (Number(container_mc.optionMc["checkBtn" + _loc1_].checked) + "\t");
        _loc1_ = _loc1_ + 1;
    }
    _loc2_ = _loc2_ + String(Number(container_mc.optionMc["checkBtn" + _loc3_].checked));
    getURL("FSCommand:ToGame_PartyWindowRaidConfig_SetCheck",_loc2_);
}
...
function ToGame_PartyWindowRaidConfig_OptionView()
{
    if(container_mc.optionMc._visible)
    {
        container_mc.optionMc._visible = false;
        getURL("FSCommand:ToGame_PartyWindowRaidConfig_OptionView",0);
    }
    else
    {
        container_mc.optionMc._visible = true;
        getURL("FSCommand:ToGame_PartyWindowRaidConfig_OptionView",1);
    }
}
...
optionBtn.setRelease(ToGame_PartyWindowRaidConfig_OptionView);
var optionCloseBtn = new lib.util.TxtBtn(container_mc.optionMc.btn);
optionCloseBtn.setRelease(function()
{
    container_mc.optionMc._visible = false;
}
);
var optionResetBtn = new lib.util.TxtBtn(container_mc.optionMc.autoBtn.btn,container_mc.optionMc.autoBtn.txt);
optionResetBtn.setRelease(ToGame_PartyWindowRaidConfig_ResetPosition);
myListener.OnGame_PartyWindowRaidConfig_OptionView = function(bool)
{
    container_mc.optionMc._visible = Boolean(Number(bool));
};
var CHECKLEN = 5;
myListener.OnGame_PartyWindowRaidConfig_SetOption = function(_view, _check)
{
    if(_view == "1")
    {
        container_mc.optionMc.radioBtn0.checked = true;
        container_mc.optionMc.radioBtn1.checked = false;
        container_mc.optionMc.lockMc._visible = false;
    }
    else
    {
        container_mc.optionMc.radioBtn0.checked = false;
        container_mc.optionMc.radioBtn1.checked = true;
        container_mc.optionMc.lockMc._visible = true;
    }
    var _loc2_ = lib.util.ExtString.split(_check,"\t");
    var _loc1_ = 0;
    while(_loc1_ < CHECKLEN)
    {
        container_mc.optionMc["checkBtn" + _loc1_].checked = Boolean(Number(_loc2_[_loc1_]));
        _loc1_ = _loc1_ + 1;
    }
};
var i = 0;
while(i < CHECKLEN)
{
    container_mc.optionMc["checkBtn" + i].idx = i;
    container_mc.optionMc["checkBtn" + i].onChanged = function()
    {
        ToGame_PartyWindowRaidConfig_SetCheck();
    };
    i++;
}
container_mc.optionMc.radioBtn0.onChanged = function()
{
    if(this.checked)
    {
        container_mc.optionMc.radioBtn1.checked = false;
        container_mc.optionMc.lockMc._visible = false;
        ToGame_PartyWindowRaidConfig_SetView(1);
    }
};
container_mc.optionMc.radioBtn1.onChanged = function()
{
    if(this.checked)
    {
        container_mc.optionMc.radioBtn0.checked = false;
        container_mc.optionMc.lockMc._visible = true;
        ToGame_PartyWindowRaidConfig_SetView(0);
    }
};

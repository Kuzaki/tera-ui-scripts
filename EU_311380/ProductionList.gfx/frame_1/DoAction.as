...
function drawBar()
{
    ...
    if(gradeBarVisible)
    {
        ...
        lib.display.DrawBitmapData.draw(container_mc.drawBox,gradeBarBm,_loc1_ + 1,99,0,0,upGradeNum,16);
    }
}
...
myListener.OnGame_ProductionList_SetStamina = function(_current, _max)
{
    ...
    container_mc.staminaTxt.text = lib.util.CurrencyFormat.makeComma(_current) + "p";
...
myListener.OnGame_ProductionList_SetTargetItem = function(_dataGroup, _rank, _stamina, _successGroup)
{
    ...
    if(_loc6_ > 0)
    {
        container_mc.targetTxt1.htmlText = TARGET_STR0 + setDecimal(_loc3_[0]) + " <font color=\'#80E71C\'> (" + TARGET_STR1 + " +" + setDecimal(_loc3_[1]) + ")</font>";
    }
    else
    {
        container_mc.targetTxt1.htmlText = TARGET_STR0 + setDecimal(_loc3_[0]) + " <font color=\'#BB0000\'> (" + TARGET_STR1 + " +" + setDecimal(_loc3_[1]) + ")</font>";
    }

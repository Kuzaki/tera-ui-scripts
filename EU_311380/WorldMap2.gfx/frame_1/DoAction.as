...
function addNumber(questId, id, leftMargin, topMargin, res, posX, posY, number, tooltipStr)
{
    ...
    if(questId != undefined && questId != "" && questId != null && questId != "undefined" && questId != "0" && questId != "-1")
    {
        ...
        if(!deleteLock)
        {
            var _loc7_ = container_mc.notice_mc._visible;
            container_mc.notice_mc._visible = true;
            if(_loc7_ != true)
            {
                var _loc8_ = container_mc.bg._height - 859;
                var _loc6_ = _loc8_ + 63;
                setResize2(_loc6_);
            }
        }
    }
...
function searchMarker(identifier, bRemove)
{
    ...
    if(bRemove)
    {
        ...
        var _loc5_ = false == deleteLock && 0 < numberCount;
        var _loc9_ = container_mc.notice_mc._visible;
        if(_loc5_ != _loc9_)
        {
            container_mc.notice_mc._visible = _loc5_;
            var _loc7_ = container_mc.bg._height - 859;
            var _loc8_ = !_loc5_?_loc7_ - 63:_loc7_ + 63;
            setResize2(_loc8_);
        }
...
{
    lib.Debuger.trace("targetId : " + targetId);
    var _loc1_ = 0;
...
function ToGame_BattleFieldMap_UseCommanderSkill(skillId, x, y)
{
    ...
    §§enumerate(container_mc.commander_mc);
    while(true)
    {
...
{
    var _loc1_ = Boolean(Number(_bTrue));
    x_btn.setEnabled(!_loc1_);
    if(_loc1_)
    {
        var _loc2_ = container_mc.attachMovie("resurrectionTip","resurrectionTip",container_mc.getNextHighestDepth());
        _loc2_._x = 20;
        _loc2_._y = 856;
        setResize2(36);
    }
    ...
    var _loc3_ = container_mc.bg._height;
    lib.Debuger.trace("CloseLock bgH : " + _loc3_);
};
...
myListener.OnGame_WorldMap_Init = function(titleStr, bgImg, upLevelLink, leftMargin, topMargin, guardComboBoxInfo, sectionComboBoxInfo, imgList, textList, mapBtnList, pointBtnList)
{
    ...
    var _loc4_ = !container_mc.resurrectionTip?0:36;
    setResize2(_loc4_);
};
...
{
    var _loc38_ = dataList.split("\n");
    var _loc39_ = _loc38_.length;
    if(_loc38_[_loc39_ - 1] == "0" || _loc38_[_loc39_ - 1] == "undefined" || _loc38_[_loc39_ - 1] == "")
    {
        _loc38_.pop();
    }
    _loc39_ = _loc38_.length;
    ...
    var _loc37_ = 0;
    var _loc21_ = 0;
    while(_loc21_ < _loc39_)
    {
        var _loc4_ = _loc38_[_loc21_].split("\t");
        if(_loc4_.length != 1)
        {
            var _loc2_ = null;
            var out = null;
            ...
            var _loc31_ = Number(_loc4_[3]);
            var _loc8_ = Number(_loc4_[4]);
            var _loc7_ = Number(_loc4_[5]);
            var _loc3_ = _loc4_[6];
            var _loc10_ = _loc4_[7];
            var _loc32_ = _loc4_[8];
            var _loc9_ = Number(_loc4_[9]);
            var _loc25_ = _loc4_[10];
            var _loc28_ = Number(_loc4_[11]);
            var clickId = _loc4_[12];
            var _loc36_ = _loc4_[13];
            var _loc19_ = Number(_loc4_[14]);
            var _loc14_ = Number(_loc4_[15]);
            var _loc11_ = Number(_loc4_[16]);
            var _loc12_ = Number(_loc4_[17]);
            _loc8_ = !isNaN(_loc8_)?_loc8_:0;
            _loc7_ = !isNaN(_loc7_)?_loc7_:0;
            _loc14_ = !(isNaN(_loc14_) || -1 == _loc14_ || 0 == _loc14_)?_loc14_ * 100:100;
            if(isNaN(_loc19_) == false && _loc19_ != -1)
            {
                addNumber(_loc36_,_loc5_,_loc8_,_loc7_,_loc3_,_loc17_,_loc16_,_loc19_,_loc10_);
            }
            else
            {
                ...
                else
                {
                    ...
                    else if(_loc9_ == 10)
                    {
                        ...
                        else if(CITYWAR_MONSTER == _loc3_ || 1 == _loc11_)
                        {
                    ...
                    else if(_loc9_ == 13)
                    {
                        ...
                        {
                            EffectAnimation(_loc37_,_loc3_,_loc2_);
                            _loc37_ = _loc37_ + 1;
                        }
                    }
                    else if(_loc9_ == 14)
                    {
                        var _loc27_ = container_mc.marker_mc.resurrection;
                        _loc2_ = _loc27_.createEmptyMovieClip(_loc5_,_loc27_.getNextHighestDepth());
                        out = _loc2_.createEmptyMovieClip("out",_loc2_.getNextHighestDepth());
                    }
                    if("MARKER_PING" == _loc25_)
                    {
                        var _loc30_ = out.attachMovie("pingHit","pingHit",out.getNextHighestDepth());
                        _loc30_._alpha = 0;
                    }
                    else
                    {
                    ...
                    out._x = out._x + _loc8_;
                    out._y = out._y + _loc7_;
                    out._xscale = out._yscale = _loc14_;
                    if(0 < _loc12_)
                    {
                        var _loc29_ = "markerBg";
                        var _loc15_ = _loc2_.attachMovie(_loc29_,"markerBg",_loc2_.getNextHighestDepth());
                        if(1 == _loc12_ || 2 == _loc12_)
                        {
                            _loc15_.gauge_1._visible = 1 == _loc12_;
                            _loc15_.gauge_2._visible = 2 == _loc12_;
                            _loc15_.gotoAndStop(_loc12_);
                            var _loc34_ = _loc15_["gauge_" + _loc12_];
                            var _loc24_ = -22;
                            var _loc23_ = -79;
                            _loc15_._x = _loc24_;
                            _loc15_._y = _loc23_;
                            out._x = _loc24_ + 7;
                            out._y = _loc23_ + 19.5;
                            var _loc35_ = getCityWarTowerHP(_loc10_);
                            _loc34_._width = CITYWAR_TOWER_GAUGE_WIDTH * (_loc35_ / 100);
                        }
                    }
                    ...
                    if(_loc28_)
                    {
                        ...
                        lib.util.DrawBitmap.draw(over,_loc32_);
                    ...
                    var _loc22_ = _loc2_;
                    if(CITYWAR_MONSTER == _loc3_ || 1 == _loc11_ || _loc3_.substr(0,CITYWAR_COMMAND.length) == CITYWAR_COMMAND)
                    {
                        if(1 != _loc11_)
                        {
                        ...
                        _loc13_ = 1 != _loc11_?_loc13_:_loc2_.markerBg.hit;
                        _loc22_ = _loc13_;
                        _loc2_.markerHit = _loc13_;
                    }
                    if("" != _loc10_)
                    {
                        _loc11_ = _loc11_ != 1?1:99;
                        lib.manager.ToolTip.add(_loc22_,_loc10_,_loc11_);
                    }
                    _loc2_._x = _loc17_;
                    _loc2_._y = _loc16_;
                    _loc2_.leftMargin = _loc8_;
                    _loc2_.topMargin = _loc7_;
                    _loc2_._rotation = _loc31_;
                    if(_loc2_ != null)
                    {
                        _loc2_.id = _loc5_;
                        _loc2_.mn = _loc25_;
                    ...
                    {
                        var _loc40_ = container_mc.BlackMarker_mc.attachMovie("Warning","Warning",container_mc.BlackMarker_mc.getNextHighestDepth());
                        _loc40_._x = _loc2_._x + effectLMargin;
                        _loc40_._y = _loc2_._y + effectTMargin;
                        _loc40_.hitTestDisable = true;
                        _loc40_.blendMode = "add";
                    }
                    else if(_loc3_ == "img://__WMap_Marker.MARKER_BF_METRO_SKILL")
                    {
                        _loc40_ = container_mc.BlackMarker_mc.attachMovie("Warning2","Warning2",container_mc.BlackMarker_mc.getNextHighestDepth());
                        _loc40_._x = _loc2_._x + _loc8_ + 16 + effectLMargin;
                        _loc40_._y = _loc2_._y + _loc7_ + 16 + effectTMargin;
                        _loc40_.hitTestDisable = true;
                        _loc40_.blendMode = "add";
                    }
                    if(_loc3_ == "img://__WMap_Marker.MARKER_PEGASUS")
                    {
                        lineStartingPoint.x = _loc17_ + _loc2_._width / 2 + _loc8_;
                        lineStartingPoint.y = _loc16_ + _loc2_._height / 2 + _loc7_;
                    }
                    else if(_loc3_ == "img://__WMap_Marker.MARKER_PEGASUS_DESTINATION")
                    {
                        var _loc18_ = container_mc.line_mc.createEmptyMovieClip("line" + _loc5_,container_mc.line_mc.getNextHighestDepth());
                        _loc18_._alpha = 50;
                        _loc18_.lineStyle(3,16764006,100);
                        _loc18_.moveTo(lineStartingPoint.x,lineStartingPoint.y);
                        _loc18_.lineTo(_loc17_ + _loc2_._width / 2 + _loc8_,_loc16_ + _loc2_._height / 2 + _loc7_);
                        _loc18_.blendMode = "add";
                        transferEndMarker(_loc2_);
                        var _loc6_ = _loc10_.split("\b");
                        var _loc20_ = _loc6_.length;
                        if(_loc6_[_loc20_ - 1] == "0" || _loc6_[_loc20_ - 1] == "undefined" || _loc6_[_loc20_ - 1] == "")
                        {
                            _loc6_.pop();
                        }
                        var _loc33_ = !(_loc6_[1] == "0" || _loc6_[1] == undefined)?"\r" + lib.util.GoldCurrency.SetGoldText(_loc6_[1]):"";
                        var _loc26_ = _loc6_[0] + _loc33_;
                        if(_loc6_[2] != "" && _loc6_[2] != undefined && _loc6_[2] != "undefined")
                        {
                            _loc26_ = _loc26_ + ("\r<font color=\'#" + lib.info.TextColor.GENERAL_IMPOSSIBLE.toString(16) + "\'>" + lib.util.UIString.getUIString("$241008") + _loc6_[2]);
                        }
                        lib.manager.ToolTip.add(_loc2_,_loc26_,1);
                    }
                    else if(_loc3_ == "img://__WMap_Marker.MARKER_PEGASUS_INACTIVE")
                    {
                        _loc6_ = _loc10_.split("\b");
                        _loc20_ = _loc6_.length;
                        if(_loc6_[_loc20_ - 1] == "0" || _loc6_[_loc20_ - 1] == "undefined" || _loc6_[_loc20_ - 1] == "")
                        {
                            _loc6_.pop();
                        }
                        _loc33_ = !(_loc6_[1] == "0" || _loc6_[1] == undefined)?"\r" + lib.util.GoldCurrency.SetGoldText(_loc6_[1]):"";
                        _loc26_ = _loc6_[0] + _loc33_;
                        if(_loc6_[2] != "" && _loc6_[2] != undefined && _loc6_[2] != "undefined")
                        {
                            _loc26_ = _loc26_ + ("\r<font color=\'#" + lib.info.TextColor.GENERAL_IMPOSSIBLE.toString(16) + "\'>" + lib.util.UIString.getUIString("$241008") + _loc6_[2]);
                        }
                    ...
                    {
                        _loc18_ = container_mc.line_mc.createEmptyMovieClip("line" + _loc5_,container_mc.line_mc.getNextHighestDepth());
                        _loc18_._alpha = 50;
                        _loc18_.lineStyle(3,16764006,100);
                        _loc18_.moveTo(lineStartingPoint.x,lineStartingPoint.y);
                        _loc18_.lineTo(_loc17_ + _loc2_._width / 2 + _loc8_,_loc16_ + _loc2_._height / 2 + _loc7_);
                    ...
                    {
                        _loc40_ = _loc2_.attachMovie("pointHit","pointHit",_loc2_.getNextHighestDepth());
                    }
                }
            }
        }
...
myListener.OnGame_WorldMap_UpdateImage = function(dataList)
{
    ...
    {
        var _loc1_ = _loc18_[_loc8_].split("\t");
        if(_loc1_.length != 1)
        {
            var _loc20_ = undefined;
            var _loc10_ = _loc1_[0];
            var _loc12_ = Number(_loc1_[1]);
            var _loc11_ = Number(_loc1_[2]);
            var _loc14_ = Number(_loc1_[3]);
            var _loc5_ = _loc1_[4];
            var _loc17_ = _loc1_[5];
            var _loc7_ = Number(_loc1_[6]);
            var _loc6_ = Number(_loc1_[7]);
            var _loc3_ = Number(_loc1_[8]);
            if(isNaN(_loc7_) == false && _loc7_ != -1)
            {
                updateNumber(_loc17_,_loc10_,_loc7_,_loc12_,_loc11_,_loc5_);
            }
            else
            {
                var _loc2_ = searchMarker(_loc10_);
                if(undefined != _loc2_)
                {
                    var _loc9_ = _loc2_.markerHit;
                    var _loc4_ = _loc2_.markerBg;
                    var _loc13_ = undefined == _loc9_?_loc2_:_loc9_;
                    if("" != _loc5_)
                    {
...
myListener.OnGame_WorldMap_DisableMapMarkerDelete = function(bool)
{
    ...
    var _loc1_ = false == bool && 0 < numberCount;
    deleteLock = bool;
    var _loc5_ = container_mc.notice_mc._visible;
    container_mc.notice_mc._visible = _loc1_;
    var _loc6_ = container_mc.bg._height;
    if(_loc5_ != _loc1_)
    {
        var _loc3_ = container_mc.bg._height - 859;
        var _loc4_ = !_loc1_?_loc3_:_loc3_ + 63;
        setResize2(_loc4_);
    }
    _loc6_ = container_mc.bg._height;
};

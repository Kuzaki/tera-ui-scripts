class com.bluehole.tera.control.LayoutActor extends gfx.core.UIComponent
{
    ...
    function updateWidgetInfo(widget, widgetData)
    {
        ...
        if(widget.container_mc == undefined)
        {
            §§enumerate(widget);
            while(true)
            {
                ...
                {
                    var _loc3_ = _loc0_;
                    if(widget[_loc3_] instanceof com.bluehole.tera.view.core.WidgetContainer)
                    {
                        widget.container_mc = widget[_loc3_];
    ...
    function openAni()
    {
        ...
        {
            this.isOpening = true;
            com.bluehole.tera.managers.LayoutManager.openingAni2(this.widget,this,this.openAni_completeHandler);
        }
    }

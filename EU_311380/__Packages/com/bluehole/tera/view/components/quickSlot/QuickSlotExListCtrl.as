class com.bluehole.tera.view.components.quickSlot.QuickSlotExListCtrl extends com.bluehole.tera.view.core.TeraTileList
{
    ...
    function draw()
    {
        ...
        if(!this.initRenderers && this.renderers.length > 0)
        {
            ...
            {
                this["shortcut__" + (_loc3_ + 50)] = this.renderers[_loc3_];
                _loc3_ = _loc3_ + 1;
            }
    ...
    function registerTooltips()
    {
        ...
        while(_loc2_ < this.renderers.length)
        {
            ...
            _loc3_._name = "shortcut__" + (_loc2_ + 50);
            lib.manager.ToolTip.add(_loc3_,_loc2_ + 50,6);
            _loc2_ = _loc2_ + 1;
        }
    }
}

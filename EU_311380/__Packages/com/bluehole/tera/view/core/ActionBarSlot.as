class com.bluehole.tera.view.core.ActionBarSlot extends gfx.controls.ItemSlot implements gfx.interfaces.IListItemRenderer
{
    ...
    {
        return (com.bluehole.tera.view.core.SlotButton)this.button.__get__effect();
    }
    ...
    {
        return (com.bluehole.tera.view.core.SlotButton)this.button.__get__active();
    }
    ...
    {
        return (com.bluehole.tera.view.core.SlotButton)this.button.__get__impossible();
    }
    ...
    {
        return (com.bluehole.tera.view.core.SlotButton)this.button.__get__playCoolTime();
    }
    ...
    {
        return (com.bluehole.tera.view.core.SlotButton)this.button.__get__black();
    }
    function __set__black(value)
    {
        (com.bluehole.tera.view.core.SlotButton)this.button.__set__black(value);
    ...
    function toString()
    {
        return "[com.bluehole.tera.view.core.ActionBarSlot " + this._name + "]";
    }
    function configUI()
    {
        super.configUI();
    ...
    function draw()
    {
        ...
        if(this.dataChanged)
        {
            ...
            if(this._data)
            {
                ...
                {
                    (com.bluehole.tera.view.core.SlotButton)this.button.__set__effect(!this._data.effect?false:this._data.effect);
                    (com.bluehole.tera.view.core.SlotButton)this.button.__set__active(!this._data.active?false:this._data.active);
                    (com.bluehole.tera.view.core.SlotButton)this.button.__set__impossible(!this._data.impossible?false:this._data.impossible);
                    (com.bluehole.tera.view.core.SlotButton)this.button.__set__playCoolTime(!this._data.playCoolTime?0:this._data.playCoolTime);
                }
            }
            else
            {
    ...
    function beginDrag()
    {
        ...
        this.oriImpossible = (com.bluehole.tera.view.core.SlotButton)this.button.impossible;
        (com.bluehole.tera.view.core.SlotButton)this.button.__set__impossible(true);
    ...
    function acceptDrop(data)
    {
        ...
        if(_loc2_ && _loc2_ instanceof com.bluehole.tera.view.core.ActionBarSlot)
        {
    ...
    {
        var _loc2_ = (com.bluehole.tera.view.core.SlotButton)this.button;
    ...
    function handlePress(event)
    {
        ...
        if(event.button == 2 && !(com.bluehole.tera.view.core.SlotButton)this.button.__get__black())
        {
    ...
    function dragEnd(event)
    {
        if(this.dragOrigin)
        {
            ...
            {
                (com.bluehole.tera.view.core.SlotButton)this.button.__set__impossible(this.oriImpossible);
                lib.Debuger.trace("slotDragCancelled");
                flash.external.ExternalInterface.call("slotDragCancelled",this._name,this.index);
            }
            lib.Debuger.trace("event.dropTarget : " + event.dropTarget);

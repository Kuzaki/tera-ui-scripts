class gfx.events.EventTypes
{
    ...
    static var DRAG_OUT = "dragOut";
    static var DRAG_OVER = "dragOver";
    static var VALUE_CHANGE = "valueChange";
    static var ADD = "add";
    static var REMOVE = "remove";
    static var UPDATE = "update";
    static var CLEAR = "clear";
    static var COOLTIME_START = "cooltimeStart";
    static var COOLTIME_END = "cooltimeEnd";
    static var COOLTIME_TICK = "cooltimeTick";
    static var COOLTIME_UPDATE = "cooltimeUpdate";
    function EventTypes()
    {
    }
}

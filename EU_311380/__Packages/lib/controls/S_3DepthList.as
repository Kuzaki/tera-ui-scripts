        ...
        while(_loc10_ < _loc15_)
        {
            ...
            while(_loc8_ < _loc14_)
            {
                ...
                while(_loc2_ < _loc11_)
                {
                    ...
                    if(_loc4_["3DL" + _loc7_[_loc2_].ID])
                    {
                        _loc3_ = _loc4_["3DL" + _loc7_[_loc2_].ID];
                    }
                    else
                    {
                        _loc3_ = _loc4_.attachMovie("lineMc_3Depth","3DL" + _loc7_[_loc2_].ID,_loc6_);
                        _loc3_.Func = this.f_Function;
                    }
                    _loc7_[_loc2_].Skin = _loc3_;
                    _loc3_.m_Parent = _loc5_;
    ...
    function SetLinePosition(_skill, _mode)
    {
        ...
        while(_loc11_ < _loc16_)
        {
            ...
            if(_loc12_.s_Folder != "CLOSE")
            {
                ...
                {
                    var _loc6_ = _loc8_[_loc5_].Skin;
                    if(_loc6_._visible != false)
                    {
                        _loc6_._y = _loc3_;
                        _loc3_ = _loc3_ + this.n_2DYPos;
                        if(_loc6_.s_Folder != "CLOSE")
                        {
                            var _loc7_ = _loc8_[_loc5_].Child;
                            var _loc2_ = 0;
                            while(_loc2_ < _loc7_.length)
                            {
                                var _loc4_ = _loc7_[_loc2_].Skin;
                                if(_loc4_._visible != false)
                                {
                                    _loc4_._y = _loc3_;
                                    _loc3_ = _loc3_ + this.n_3DYPos;
                                }
                                _loc2_ = _loc2_ + 1;
                            }
                        }

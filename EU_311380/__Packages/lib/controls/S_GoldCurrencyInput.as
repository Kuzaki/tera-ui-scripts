class lib.controls.S_GoldCurrencyInput extends MovieClip
{
    var gold_nums = 0;
    var silver_nums = 0;
    var bronze_nums = 0;
    ...
    function S_GoldCurrencyInput()
    {
        ...
        this.GoldCurrencyBtn(this._min,this._max);
    ...
    function GoldCurrencyBtn(_mins, _maxs)
    {
        if(_mins != undefined)
        {
            this._min = _mins;
        ...
        if(this._max <= this.total_nums)
        {
            this._scope.min_mc.gotoAndStop(1);
            this._scope.max_mc.gotoAndStop(4);
        }
        if(this._min >= this.total_nums)
        {
            this._scope.min_mc.gotoAndStop(4);
            if(this._max > 0 && this._max > this._min)
            {
                this._scope.max_mc.gotoAndStop(1);
            }
        }
        ...
        if(this._min < this.total_nums && this._max > this.total_nums)
        {
            this._scope.min_mc.gotoAndStop(1);
            this._scope.max_mc.gotoAndStop(1);
        }
        ...
        this._scope.min_mc.onRelease = function()
        {
            ...
            {
                this.gotoAndStop(1);
                this._parent.GoldCurrencyInputSingle(this._parent._min);
            }
        };
        ...
        this._scope.max_mc.onRelease = function()
        {
            ...
            {
                this.gotoAndStop(1);
                this._parent.GoldCurrencyInputSingle(this._parent._max);
            }
        };
    }

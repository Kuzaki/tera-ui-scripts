class lib.gamedata.CustomizedUIDataCollection extends lib.gamedata.GameDataCollectionImpl
{
    ...
    function createDefaultDatas()
    {
        ...
        this.defaults.addData(new lib.gamedata.CustomizedUIData(lib.gamedata.CustomizedUIDataKey.BATTLE_MESSAGE_SEPARATION_BOOLEAN,1));
        this.defaults.addData(new lib.gamedata.CustomizedUIData(lib.gamedata.CustomizedUIDataKey.BATTLE_MESSAGE_SEPARATION_MARK_TYPE,1));
        this.defaults.addData(new lib.gamedata.CustomizedUIData(lib.gamedata.CustomizedUIDataKey.BATTLE_MESSAGE_RECOVERY_BOOLEAN,1));
    }

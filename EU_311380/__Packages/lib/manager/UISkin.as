class lib.manager.UISkin
{
    ...
    var skinException = ["WorldMap2","TargetInfo","OverlayMap2","SenatorMap","TradeHouse","DungeonRanking","PartyWindowRaidConfig","BFRanking","InGameBookMark","UpdateNotification","Union"];

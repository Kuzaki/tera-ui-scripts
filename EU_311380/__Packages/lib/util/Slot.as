class lib.util.Slot extends MovieClip
{
    ...
    function setData(data)
    {
        ...
        this.slotData.addEventListener(gfx.events.EventTypes.COOLTIME_START,this,"cooltimeHandler");
        this.slotData.addEventListener(gfx.events.EventTypes.COOLTIME_END,this,"cooltimeHandler");
        this.slotData.addEventListener(gfx.events.EventTypes.COOLTIME_TICK,this,"cooltimeHandler");
        this.slotData.addEventListener(gfx.events.EventTypes.COOLTIME_UPDATE,this,"cooltimeHandler");
    ...
    function init()
    {
        ...
        true;
        this.o.BG_EMPTY._visible = this.canDrag;
        this.o.up_txt.text = "";
    ...
    function clear()
    {
        ...
        this.slotData.removeEventListener(gfx.events.EventTypes.COOLTIME_START,this,"cooltimeHandler");
        this.slotData.removeEventListener(gfx.events.EventTypes.COOLTIME_END,this,"cooltimeHandler");
        this.slotData.removeEventListener(gfx.events.EventTypes.COOLTIME_TICK,this,"cooltimeHandler");
        this.slotData.removeEventListener(gfx.events.EventTypes.COOLTIME_UPDATE,this,"cooltimeHandler");
    ...
    function setRelease(func)
    {
        this.o.SLOT.onRelease = function()
        {
            ...
            lib.Debuger.trace("Slot - this._parent.effect : " + this._parent.effect);
            if(this._parent.effect)
            {
                lib.Debuger.trace("Slot - this._parent.FX_PRESS : " + this._parent.FX_PRESS);
        ...
        {
            lib.Debuger.trace("Slot - 바깥에서 떼였음");
        };
    }
    ...
    function cooltimeHandler(event)
    {
        ...
        if(event.type != gfx.events.EventTypes.COOLTIME_START)
        {
            if(event.type == gfx.events.EventTypes.COOLTIME_END)
            {
                this.centerCount_txt.text = "";
                this.coolTimeDraw_mc.clear();
            }
            else if(event.type == gfx.events.EventTypes.COOLTIME_TICK)
            {
            ...
            else if(event.type == gfx.events.EventTypes.COOLTIME_UPDATE)
            {
            }
        }
    }

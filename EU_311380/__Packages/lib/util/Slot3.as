class lib.util.Slot3 extends MovieClip
{
    var canDrag = true;
    var isActive = false;
    var canEffect = true;
    ...
    function Slot3()
    {
        ...
        this.btnWork();
        this.o.up_txt.textColor = lib.info.TextColor.SLOT_PAPER_NORMAL;
        this.o.center_txt.textColor = lib.info.TextColor.SLOT_PAPER_CENTER;
        this.o.down_txt.textColor = lib.info.TextColor.SLOT_PAPER_MONEY;
        this.o.guidNum_mc._visible = false;
    ...
    function resize()
    {
        ...
        this.o.guidNum_mc._x = this.slotWidth - this.o.guidNum_mc._width - 2;
    ...
    function showMoney(bTrue)
    {
        ...
        if(bTrue)
        {
            ...
            _loc2_.size = 14;
            _loc2_.align = "right";
            _loc2_.color = lib.info.TextColor.SLOT_PAPER_MONEY;
        ...
        else
        {
            ...
            _loc2_.size = 16;
            _loc2_.align = "left";
            _loc2_.color = lib.info.TextColor.SLOT_PAPER_NORMAL;
    ...
    function __get__num()
    {
        return this.o.Slot.num_txt.text;
    }
    function __set__num(str)
    {
        this.slotCount = str = String(str);
        this.o.Slot.slotCount = this.slotCount;
    ...
    function __set__active(bTrue)
    {
        ...
        if(this.o.effect)
        {
            if(this.o.guidNum_mc._visible)
            {
                this.o.guidNum_mc.gotoAndStop(2);
            }
            if(bTrue)
            {
    ...
    function __set__grade(_g)
    {
        ...
        var _loc2_ = undefined;
        if(this.__get__grade() == -1)
        {
            _loc2_ = 46335;
        }
        else
        {
            _loc2_ = lib.info.TextColor["RAREGRADE_PAPER" + _g];
        }
        this.o.up_txt.textColor = _loc2_;
    ...
    function __set__enabledGuidNum(checked)
    {
        this.o.guidNum_mc._visible = true;
        this.o.guidNum_mc.checked = Number(checked);
        this.o.guidNum_mc.gotoAndStop(Number(checked) + 1);
        this.o.guidNum_mc.onLoad = function()
        {
            this.gotoAndStop(this.checked + 1);
        };
        return this.__get__enabledGuidNum();
    }
    ...
    function __set__masterpiece(bTrue)
    {
        ...
        {
            _loc3_ = lib.util.SlotInnerAttacher.attach(this.o.Slot,"wakeup",{align:"BR",rightMargin:1,bottomMargin:1,name:lib.util.SlotInnerAttacher.ICON_MASTERPIECE,depth:"icon"});
        }
        else
        {

class lib.util.Snapper extends gfx.events.EventDispatcher
{
    var bletTickness = 2;
    ...
    function createDragEvent()
    {
        ...
        if(this.bUIDrager)
        {
            this._UIDrager.onPress2 = function()
            {
                ...
                thisSnapper.dispatchEvent({type:gfx.events.EventTypes.DRAG_BEGIN,target:thisSnapper});
            };
            this._UIDrager.onRelease2 = function()
            {
                thisSnapper.setDragging(false);
                thisSnapper.dispatchEvent({type:gfx.events.EventTypes.DRAG_END,target:thisSnapper});
